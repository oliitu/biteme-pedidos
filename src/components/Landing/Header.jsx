export default function Header() {
  return (
    <header className="w-full h-[50vh] sm:h-[80vh] md:h-[75vh] header bg-cover bg-center flex items-center justify-center">
      <section className="px-4 sm:px-6 text-center max-w-3xl">
        ...
        <a
          href="#productos"
          className="inline-block text-white font-semibold font-poppins px-6 py-3 rounded-full text-sm sm:text-base transition"
        >
          Ver productos
        </a>
      </section>
